...
$ip=get_ip();
$now=time();
	if (file_exists("nina_firewall/$ip".".deny"))//Neu bi khoa vinh vien
		{
			//Cam bang htaccess
	...
	elseif (file_exists("nina_firewall/$ip".".lock")) //Neu dang bi khoa tam thoi
		{
			@chmod("nina_firewall/$ip".".lock", 0666);
			@$time=file_get_contents("nina_firewall/$ip".".lock");
