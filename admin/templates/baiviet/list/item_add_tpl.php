		...
		<div class="<?=($config_cap1['full']==true) ? 'oneOne':'colRight' ?>">
			...
			<div class="widget mtop10">
				...
				<div class="formRow lang_hidden lang_vi active">
					...
					<div class="formRight">
		                <input type="text" name="name_vi" title="Nhập tiêu đề quảng cáo" id="name_vi" class="tipS" value="<?=@$item['name_vi']?>" />
					</div>
					<div class="clear"></div>
				</div>
				
				<div class="formRow lang_hidden lang_en">
					<label>Tiêu đề quảng cáo (Tiếng anh)</label>
					<div class="formRight">
		                <input type="text" name="name_en" title="Nhập tiêu đề quảng cáo" id="name_en" class="tipS" value="<?=@$item['name_en']?>" />
					</div>
					<div class="clear"></div>
				</div>
				<div class="formRow">
				...
				<div class="formRow">
					...
					<div class="formRight">
		                <input type="text" name="links" title="Nhập links quảng cáo" id="links" class="tipS validate[required]" value="<?=@$item['links']?>" />
					</div>
					<div class="clear"></div>
				</div>
			</div>
